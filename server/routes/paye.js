...
router.post('/payeCalculator',async(req,res)=>{
     ...
     try {
          ...
          taxableIncome= await grossSalary - totalReductions;
          ...
          if(taxableIncome > firstLevel){
             ...
             if(remainingAmount >secondLevel){
                  ...
                  totalTax += taxDue2;
                  return res.status(200).json({grossSalary,netPay,contributionBenefit,taxableIncome,totalTax,personalRelief,insuranceRelief,PAYE,paymentPeriod});
             }
